...
public class NotificationService : INotificationService
{
    ...
    public async Task<ApiResponse<List<NotificationDto>>> GetByUserIdAsync(
        int userId,
        bool? isRead = null
    )
    {
    ...
    public async Task CreateBillGeneratedNotificationAsync(
        int userId,
        int billId,
        string billNumber,
        decimal amount
    )
    {
        var notification = new Notification
        {
            ...
            Message =
                $"A new bill ({billNumber}) has been generated for {amount:C}. Please pay before the due date.",
    ...
    public async Task CreatePaymentReceivedNotificationAsync(
        int userId,
        int paymentId,
        decimal amount
    )
    ...
    public async Task CreateDueDateReminderAsync(
        int userId,
        int billId,
        string billNumber,
        DateTime dueDate
    )
    {
        var notification = new Notification
        {
            ...
            Message =
                $"Reminder: Bill {billNumber} is due on {dueDate:MMM dd, yyyy}. Please make your payment to avoid late fees.",
    ...
    private static NotificationDto MapToDto(Notification notification)
    {
        return new NotificationDto
        {
            ...
            ReadAt = notification.ReadAt.HasValue
                ? DateTime.SpecifyKind(notification.ReadAt.Value, DateTimeKind.Utc).ToLocalTime()
                : null,
            CreatedAt = DateTime
                .SpecifyKind(notification.CreatedAt, DateTimeKind.Utc)
                .ToLocalTime(),
        };
    }
}
